...
(function() {
  var Brick, BrickAudio, CheeSynth, Claud, Fixture, Loudspeaker, Test, Wave, brickClasses, test,
  ...
  Brick = (function() {
    ...
    function Brick(opt) {
      this.id = this.I.charAt(0).toLowerCase() + zeroPad(++tally);
    }
  ...
  CheeSynth = (function() {
    ...
    CheeSynth.prototype.createBrick = function(x, y, brickClass) {
      var brick;
  ...
  Wave = (function(_super) {
    ...
    function Wave(opt) {
      ...
      this.oscillator.type = opt.type || 'square';
      this.oscillator.frequency.value = opt.freq || 70;
      this.oscillator.start();
    }

    Wave.prototype.connect = function(from, to) {
      claud.log(this.id + '.' + from.c, 'connects to ', to.f.brick.id + '.' + to.c);
      if ('Loudspeaker' === to.f.brick.I) {
        return this.oscillator.connect(CheeSynth.ctx.destination);
      }
    };

    Wave.prototype.disconnect = function(from, to) {
      claud.log(this.id + '.' + from.c, 'disconnects from ', to.f.brick.id + '.' + to.c);
      if ('Loudspeaker' === to.f.brick.I) {
