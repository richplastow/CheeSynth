...
(function() {
  ...
  test.equal([
    ...
    }, "`cs.width` is zero by default", 0, function() {
      return (new CheeSynth()).width;
    }, "`cs.height` is zero by default", 0, function() {
      return (new CheeSynth()).height;
    }, "`cs.width` can be set", 3, function() {
      return (new CheeSynth({
        width: 3
      })).width;
    }, "`cs.height` can be set", 4, function() {
      return (new CheeSynth({
        height: 4
      })).height;
    }
  ...
  test.section("Simple Render Usage");
