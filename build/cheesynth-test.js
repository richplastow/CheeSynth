...
(function() {
  var Brick, BrickAudio, CheeSynth, Claud, Fixture, Loudspeaker, Param, Test, Wave, brickClasses, test,
  ...
  Wave = (function(_super) {
    ...
    Wave.prototype.maintain = function(from, to) {
      claud.log(this.id + '.' + from.c, 'still connected to ', to.f.brick.id + '.' + to.c);
